	...
	CREATE TABLE Clients ( id int NOT NULL AUTO_INCREMENT PRIMARY KEY,usertype INT, companyname varchar(30) DEFAULT NULL,representativename varchar(20) DEFAULT NULL, 
    nit int(15) DEFAULT NULL,email varchar(60) DEFAULT NULL, contactnumber varchar(20) DEFAULT NULL, city varchar(30) DEFAULT NULL, comercialactivity longtext DEFAULT NULL,
 	user varchar(10) DEFAULT NULL, password varchar(50) DEFAULT NULL);

	CREATE TABLE Users (id INT AUTO_INCREMENT PRIMARY KEY,usertype INT,artistname VARCHAR(30),name VARCHAR(30),lastname VARCHAR(30),
    phone VARCHAR(20),contactphone VARCHAR(20),creationdate VARCHAR(30),city VARCHAR(30),whatsapp INT(1),experience LONGTEXT,
    achievements LONGTEXT,services LONGTEXT,paymentmethod LONGTEXT,contactemail VARCHAR(60),email VARCHAR(60),password TEXT,picture LONGTEXT,
    location TEXT,sharelocation INT(1));
